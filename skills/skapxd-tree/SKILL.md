...
The command is pinned to `@skapxd/tree@1.2.1` so external security tools can evaluate a stable package version. Update the pin only when intentionally releasing and validating a new package version.

## Commands

```bash
npx --yes @skapxd/tree@1.2.1
npx --yes @skapxd/tree@1.2.1 ./src
npx --yes @skapxd/tree@1.2.1 ./src --only-folder
npx --yes @skapxd/tree@1.2.1 ./src --ignore "node_modules|dist|coverage|.next"
npx --yes @skapxd/tree@1.2.1 src/index.ts
npx --yes @skapxd/tree@1.2.1 src/routes/page.tsx -r
npx --yes @skapxd/tree@1.2.1 docs/index.md -r
```
